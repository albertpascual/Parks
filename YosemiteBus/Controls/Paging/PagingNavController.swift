...
class PagingNavController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        pageControl.frame = CGRect(x: 150, y: 55, width: 0, height: 0)
        ...
        closeButton = UIButton() //UIButton(frame: CGRect(x: 200, y: 100, width: wBounds, height: 20))
        closeButton.frame = CGRect(x: 200, y: 100, width: 100, height: 20)
        closeButton.setTitle("Close", forState: .Normal)
        closeButton.setTitleColor(UIColor.whiteColor(), forState: .Normal)
        closeButton.addTarget(self, action: "pressed:", forControlEvents: .TouchDown)
        ...
        var titleSize = CGRect(x: 150, y: 90, width: wBounds, height: 20)
        ...
        self.view.addSubview(navTitleLabel1)
        ...
        self.view.addSubview(navTitleLabel2)
        ...
        self.view.addSubview(navTitleLabel3)
    ...
    func scrollViewDidScroll(scrollView: UIScrollView) {
        ...
        navTitleLabel1.frame = CGRectMake(offsetPosition, 20, wBounds, 20)
        navTitleLabel2.frame = CGRectMake(offsetPosition + 100, 20, wBounds, 20)
        navTitleLabel3.frame = CGRectMake(offsetPosition + 200, 20, wBounds, 20)
